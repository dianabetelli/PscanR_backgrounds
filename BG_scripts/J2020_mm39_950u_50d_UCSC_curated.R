...
J2020_PSBG <- PscanR::ps_build_bg(prom_seq, J2020, BPPARAM = BiocParallel::MulticoreParam(18)) #Build Pscan Background

PscanR::ps_write_bg_to_file(J2020_PSBG, "J2020_mm39_950u_50d_UCSC.psbg.txt")