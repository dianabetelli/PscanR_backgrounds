hs1_path <- system.file('extdata/BG_files', 'GCF_009914755.1_T2T-CHM13v2.0_genomic.gff.gz', package = 'PscanR')
...
PscanR::ps_write_bg_to_file(J2022_PSBG, "J2022_hs1_1000u_0d_UCSC.psbg.txt")