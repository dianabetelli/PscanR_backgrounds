...
J2022_PSBG <- PscanR::ps_build_bg(prom_seq, J2022, BPPARAM = BiocParallel::MulticoreParam(8)) #Build Pscan Background

PscanR::ps_write_bg_to_file(J2022_PSBG, "J2022_hs1_950u_50d_UCSC.psbg.txt")