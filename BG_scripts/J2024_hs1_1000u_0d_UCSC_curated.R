...
J2024_PSBG <- PscanR::ps_build_bg(prom_seq, J2024, BPPARAM = BiocParallel::MulticoreParam(18)) #Build Pscan Background

PscanR::ps_write_bg_to_file(J2024_PSBG, "J2024_hs1_1000u_0d_UCSC.psbg.txt")
